...
@section('content')
    <div class="card">
        <div class="card-header">
            Проекты <a href="/user/projects/add" class="btn btn-success"><i class="fa fa-plus"></i></a>
        </div>
                    ...
                    @if ($projects)
                        @foreach($projects as $p)
                            <tr>
                                ...
                                <td>
                                    <a href="/user/projects/edit/{{$p['id']}}" class="btn btn-success">
